...
import { useScrollPosition, useOptimizedMotion } from "@/lib/performance";
  ...
  return (
    <header
      ...
      style={{
        ...
        backdropFilter: "none", // Removed expensive backdrop-filter
        backfaceVisibility: "hidden", // Performance optimization
      }}
    >
      <div
        className="container relative flex h-16 items-center justify-between max-w-[calc(100%-0.5rem)] mx-auto px-4 overflow-x-clip"
        style={{ width: "100%" }}
      >
